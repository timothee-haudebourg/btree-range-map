...
fn insert_exclusive_ranges() {
	...
	range_map.insert_range(00..05, true);
	range_map.insert_range(10..15, false);
	range_map.insert_range(20..25, true);
	range_map.insert_range(30..35, false);
	range_map.insert_range(40..45, true);
	range_map.insert_range(50..55, false);
	range_map.insert_range(60..65, true);
	range_map.insert_range(70..75, false);
	range_map.insert_range(80..85, true);
...
fn insert_inclusive_ranges_a() {
	...
	range_map.insert_range(00..20, true); // case (G)
...
fn insert_inclusive_ranges_ce() {
	...
	range_map.insert_range(10..30, true); // case (G)
...
fn insert_inclusive_ranges_bcd() {
	...
	range_map.insert_range(10..15, true); // case (G)
	range_map.insert_range(20..25, true); // case (G)
	range_map.insert_range(30..35, true); // case (G)
...
fn insert_merge_ranges() {
	...
	range_map.insert_range(10..20, true);
